...
<jsp:useBean id="sampleMessageWriterImplProxyid" scope="session" class="ws.service.MessageWriterImplProxy" />
<%
...
case 10:
        gotMethod = true;
        ws.service.MessageWriterImpl getMessageWriterImpl10mtemp = sampleMessageWriterImplProxyid.getMessageWriterImpl();
