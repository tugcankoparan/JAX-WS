...
public class MessageWriterImplProxy implements ws.service.MessageWriterImpl {
  private String _endpoint = null;
  private ws.service.MessageWriterImpl messageWriterImpl = null;
  ...
  private void _initMessageWriterImplProxy() {
    try {
      messageWriterImpl = (new ws.service.MessageWriterImplServiceLocator()).getMessageWriterImpl();
  ...
  public ws.service.MessageWriterImpl getMessageWriterImpl() {
    if (messageWriterImpl == null)
      _initMessageWriterImplProxy();
