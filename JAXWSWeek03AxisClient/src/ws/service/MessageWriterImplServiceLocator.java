...
public class MessageWriterImplServiceLocator extends org.apache.axis.client.Service implements ws.service.MessageWriterImplService {
    ...
    private java.lang.String MessageWriterImpl_address = "http://localhost:8080/JAXWSWeek03Axis/services/MessageWriterImpl";
    ...
    public ws.service.MessageWriterImpl getMessageWriterImpl() throws javax.xml.rpc.ServiceException {
    ...
    public ws.service.MessageWriterImpl getMessageWriterImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.service.MessageWriterImplSoapBindingStub _stub = new ws.service.MessageWriterImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.service.MessageWriterImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.service.MessageWriterImplSoapBindingStub _stub = new ws.service.MessageWriterImplSoapBindingStub(new java.net.URL(MessageWriterImpl_address), this);
                _stub.setPortName(getMessageWriterImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.ws", "MessageWriterImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.ws", "MessageWriterImpl"));
        }
